...
namespace TaskManager
{
    ...
    public partial class Collection : Form
    {
        ...
        public Collection(string name, string surname, string NameCollection, string email)
        {
            InitializeComponent();
            CollectionLabel.Text = NameCollection;
            NameTable = name;
        ...
        public void CreateCards()
        {
            ...
            string query2 = $"SELECT id, brand, model, priceRUB, maxspeed, horsepower, country, Score, Favorites FROM {NameTable}{SurnameTable}Table WHERE PlayList = '{NameCollection}'";
